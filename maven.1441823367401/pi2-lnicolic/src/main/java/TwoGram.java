...
public class TwoGram extends NGram {
  ...
  public final static int typeIndexID = JCasRegistry.register(TwoGram.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TwoGram() {/* intentionally empty block */}
   ...
   */
  public TwoGram(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TwoGram(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
