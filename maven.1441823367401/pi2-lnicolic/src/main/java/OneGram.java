 ...
 * @generated */
public class OneGram extends NGram {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(OneGram.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected OneGram() {/* intentionally empty block */}
   ...
   */
  public OneGram(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public OneGram(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
