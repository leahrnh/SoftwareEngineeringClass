 ...
 * @generated */
public class ThreeGram extends NGram {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ThreeGram.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ThreeGram() {/* intentionally empty block */}
   ...
   */
  public ThreeGram(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ThreeGram(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
